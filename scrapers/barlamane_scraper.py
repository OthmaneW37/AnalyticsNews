"""
barlamane_scraper.py
--------------------
Scraper pour Barlamane (https://www.barlamane.com) — média marocain.
...
class BarlamaneScraper(BaseScraper):
    """
    Scrape les articles Barlamane via RSS.
    """
    ...
    def fetch_articles(self) -> list[Article]:
        ...
        for feed_url in BARLAMANE_FEEDS:
